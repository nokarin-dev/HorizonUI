# Kebijakan Ekstensi HorizonUI

Dokumen ini menjelaskan kebijakan terkait **ekstensi eksternal** dalam proyek HorizonUI, khususnya aset latar belakang untuk HorizonUI: Java Edition dan HorizonUI: Bedrock Edition.

---

## Ringkasan

HorizonUI mendukung **latar belakang kustom eksternal** (statis atau animasi) melalui sistem paket sumber daya yang fleksibel.  
...
- **Latar belakang NSFW** atau konten yang bersifat seksual, kekerasan, atau tidak pantas lainnya **dilarang keras** di komunitas resmi HorizonUI (Discord, forum, dll.).
...
- Latar belakang kustom harus mengikuti struktur folder ini:  
  `assets/HorizonUI/background/<name>/`
...
- Mendistribusikan ulang mod HorizonUI atau kode yang dikompilasi bersama latar belakang Anda.
- Mengklaim ekstensi Anda sebagai “resmi” atau didukung oleh tim HorizonUI.
...
Dengan menggunakan atau membuat ekstensi untuk HorizonUI, Anda setuju dengan kebijakan ini.  
Untuk pengiriman, pameran, atau pertanyaan, silakan hubungi Penulis atau bergabung dengan server Discord resmi HorizonUI.
