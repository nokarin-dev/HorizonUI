---
name: "Bug Report"
about: "Report an issue or unexpected behavior in HorizonUI"
title: "[BUG] "
labels: bug
...
- [ ] I am using the latest version of HorizonUI.
- [ ] I have tested this issue with only HorizonUI installed (if possible).
